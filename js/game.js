$(function() {
    $('#startgame').click(function() {
        ...
        $('body').append('<div id="instruction"><h2 id="content" style="margin-top:50px; border: 3px, solid, black; background:white;">Please add the items into your basket by clicking on them</h2></div>');
        ...
        var updateInstruction = function() {
            ...
            for (var i = 0; i < 5; i++) {
                if (foodCount[i] < 0) {
                    s += "You took too many " + foodName[i] + "<br><br>";
                }
            }
